...
">
            <h1 class="display-4 font-weight-bold ">
                ...
                <a class="text-light" href="https://www.linkedin.com/in/devharitwal" target="_blank"
                    rel="noopener noreferrer"> Dev Ratna Haritwal</a>
            </h1>
            ...
            <div>
                ...
                <div class="row">
                    <div class="col">
                        <p class="lead d-flex">
                            <a class="btn text-white btn-md m-1 " style="background-color: black;" target="_blank"
                                rel="noopener noreferrer" href="https://github.com/devharitwal" role="button">GitHub</a>
                            <a class="btn btn-light btn-md m-1 " target="_blank" rel="noopener noreferrer"
                                href="https://www.linkedin.com/in/devharitwal/" role="button">LinkedIn </a>
                        </p>
                    </div>
                </div>
